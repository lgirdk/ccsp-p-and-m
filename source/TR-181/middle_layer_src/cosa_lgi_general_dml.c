    ...
    )
{
    ...
    if (strcmp(ParamName, "VMBIPAddress") == 0)
    {
        return CosaDmlGiGetVmbIpAddress(NULL, pValue, pulSize);
    }
    if (strcmp(ParamName, "VMBSubnetMask") == 0)
    {
        return CosaDmlGiGetVmbSubnetMask(NULL, pValue, pulSize);
    }
